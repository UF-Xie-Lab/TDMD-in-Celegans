...
class Statistic():
    ...
    def fasta_length_distribution(self, input1):
        ...
        f2.query('length >= 18', inplace=True)
        f2.sort_values(by=['length'], ascending=True, inplace=True)
        f2.to_csv(input1.replace('fasta', 'csv').replace('fasta', 'csv'), index=False)
        sns.set(style="darkgrid", rc={'figure.figsize': (20, 10)})
        sns.set(font_scale=2)
...
if __name__ == "__main__":
    ...
    command_line()
    # os.chdir("/Users/rui/Dropbox (UFL)/Desk_Drive/Exp 330. 2023-07-13 eClip c elegan test sample 2nd")
    # Combined_table(outfile='Celegans_20230713_2nd.txt').input_multiple_raw_clash(
    #     viennad_files='S1.cutUMI_comp_20230616martquery_0613142828_717_WBcel235_unique_hybrids_ua_compressed_AUex_region.txt,S2.cutUMI_comp_20230616martquery_0613142828_717_WBcel235_unique_hybrids_ua_compressed_AUex_region.txt,S3.cutUMI_comp_20230616martquery_0613142828_717_WBcel235_unique_hybrids_ua_compressed_AUex_region.txt,S4.cutUMI_comp_20230616martquery_0613142828_717_WBcel235_unique_hybrids_ua_compressed_AUex_region.txt')
